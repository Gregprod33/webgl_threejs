...
export class RobotComponent implements OnInit, AfterViewInit {
  ...
  private createScene() {
    ...
    this.loaderGLTF.load('assets/images/scene.gltf', (gltf: GLTF) => {
    ...
    this.ambientLight = new THREE.AmbientLight(0x101010, 30);
    ...
    this.light2 = new THREE.PointLight(0x101010, 10);
    this.light2.position.set(500, 100, 0);
    this.scene.add(this.light2);
    this.light3 = new THREE.PointLight(0x101010, 15);
    this.light3.position.set(0, 100, -500);
    this.scene.add(this.light3);
    this.light4 = new THREE.PointLight(0x101010, 40);
 ...
 */
  private startRenderingLoop() {
    ...
    let component: RobotComponent = this;
    (function render() {
  ...
  updateScreenPosition() {
    ...
    this.robotButton.style.top = `${vector.y}px`;
    this.robotButton.style.left = `${vector.x}px`;
    this.robotButton.style.opacity = this.spriteBehindObject ? "0.25" : "1";
    const earthLabel = new CSS2DObject(this.robotButton);
  ...
  ngAfterViewInit() {
    this.robotButton = <HTMLDivElement>document.querySelector(".robot-bouton");
    this.createScene();
